...
export const products: Product[] = [
  {
    ...
    weightOptions: [
      { weight: '۱ کیلوگرم', price: 12.99 },
      { weight: '۵ کیلوگرم', price: 59.99 },
      { weight: '۱۰ کیلوگرم', price: 110.00 },
    ],
    rating: 4.8,
    reviewCount: 125,
    discount: 10,
  ...
  },
  {
    ...
    weightOptions: [
      { weight: '۱ کیلوگرم', price: 15.99 },
      { weight: '۵ کیلوگرم', price: 75.99 },
    ],
    rating: 4.9,
    reviewCount: 98,
    discount: 0,
  ...
  },
  {
    ...
    weightOptions: [
      { weight: '۱ کیلوگرم', price: 10.99 },
      { weight: '۵ کیلوگرم', price: 52.99 },
      { weight: '۱۰ کیلوگرم', price: 99.99 },
    ],
    rating: 4.7,
    reviewCount: 210,
    discount: 0,
  ...
  },
  {
    ...
    weightOptions: [
      { weight: '۱ کیلوگرم', price: 18.99 },
      { weight: '۲.۵ کیلوگرم', price: 45.99 },
    ],
    rating: 4.6,
    reviewCount: 55,
    discount: 15,
  ...
  },
  {
    ...
    weightOptions: [
      { weight: '۱ کیلوگرم', price: 14.99 },
      { weight: '۵ کیلوگرم', price: 70.00 },
    ],
    rating: 4.8,
    reviewCount: 72,
    discount: 0,
  ...
  },
  {
    ...
    weightOptions: [
      { weight: '۵ کیلوگرم', price: 45.99 },
      { weight: '۱۰ کیلوگرم', price: 85.00 },
      { weight: '۲۰ کیلوگرم', price: 160.00 },
    ],
    rating: 4.5,
    reviewCount: 150,
    discount: 5,
